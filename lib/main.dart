      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Enhancement: gradient background behind the interactive painter
            Container(
              height: 320,
              ...
              child: CustomPaint(
                // toggle showMultipleCopies to false if you only want one
                painter: EmojiPainter(_selected, showMultipleCopies: true),
...
class EmojiPainter extends CustomPainter {
  ...
  final bool showMultipleCopies;
  EmojiPainter(this.selected, {this.showMultipleCopies = false});

  @override
  void paint(Canvas canvas, Size size) {
    // Draw main (center) emoji
    _drawSelected(canvas, size);

    // (Hint) Draw extra faces at different positions
    if (showMultipleCopies) {
      canvas.save();
  ...
  bool shouldRepaint(covariant EmojiPainter oldDelegate) =>
      oldDelegate.selected != selected || oldDelegate.showMultipleCopies != showMultipleCopies;
}
